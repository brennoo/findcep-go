...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Enderecos.Pesquisa(context.Background(), findcep.EnderecoPesquisaParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Enderecos.Pesquisa(cancelCtx, findcep.EnderecoPesquisaParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Enderecos.Pesquisa(deadlineCtx, findcep.EnderecoPesquisaParams{})
		if err == nil {
