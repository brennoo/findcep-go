...
The Findcep Go library provides convenient access to the [Findcep REST API](https://docs.findcep.com)
...
```sh
go get -u 'github.com/brennoo/findcep-go@v0.1.0-alpha.4'
```
...
`*findcep.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `findcep.FileParam(reader io.Reader, filename string, contentType string)`
